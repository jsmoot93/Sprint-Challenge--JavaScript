...
let universities = graduates.map(function(currentValue){
...
let uni = graduates.filter(function(currentValue){
  if (currentValue.university.includes("Uni") === true) {
    return `${currentValue.university}`;
  }
});
console.log(uni);
...
*/
let lowerCase = zooAnimals.map(function(currentValue){
...
*/
let largerPopulation = zooAnimals.filter(function(currentValue){
